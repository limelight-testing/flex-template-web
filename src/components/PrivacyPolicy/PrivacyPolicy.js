...
const PrivacyPolicy = props => {
  ...
  return (
    <div className={classes}>
      ...
      <p>
      The Limelight Internet Showcase, LLC, (The Limelight Music Marketplace), is committed to
keeping any and all personal information collected of those individuals that visit our website and
make use of our online facilities and services accurate, confidential, secure and private. Our
privacy policy has been designed and created to ensure those affiliated with The Limelight
Internet Showcase, LLC of our commitment and realization of our obligation not only to meet but
...
<p>
It is highly recommended and suggested that you review the privacy policies and statements of
any website you choose to use or frequent as a means to better understand the way in which
other websites garner, make use of and share information collected.
</p>
...
<li>Information automatically collected when visiting our website, which may include
...
The Limelight Internet Showcase, LLCmay have the occasion to collect non-personal
anonymous demographic information, such as age, gender, household income, political
affiliation, race and religion, as well as the type of browser you are using, IP address, type of
operating system, at a later time, that will assist us in providing and maintaining superior
quality service.
      </p>

      <h3>Use of Information Collected</h3>
      <p>
The Limelight Internet Showcase, LLCmay collect and may make use of personal information
...
The Limelight Internet Showcase, LLC may deem it necessary to follow websites and/or
pages that their users may frequent in an effort to gleam what types of services and/or
products may be the most popular to customers or the general public.
The Limelight Internet Showcase, LLCmay disclose your personal information, without any
prior notice to you, unless required to do in accordance to applicable laws and/or in a good
faith belief that such action is deemed necessary or required in an effort to:</p>
<ul className={css.list}>
...
<p>
The Limelight Internet Showcase, LLCgreatly respects your privacy. We do maintain and
reserve the right to contact you if needed for non-marketing purposes (such as bug alerts,
security breaches, account issues, and/or changes in The Limelight Internet Showcase, LLC
products and services). In certain circumstances, we may use our website, newspapers, or
other public means to post a notice.</p>
<h3>Children Under Age of 13</h3>
<p>
The Limelight Internet Showcase, LLCdoes not knowingly collect personal identifiable
...
email that you wish to unsubscribe to <ExternalLink href="mailto:limelightmanagementgroup@gmail.com">limelightmanagementgroup@gmail.com</ExternalLink>. If you wish to
unsubscribe or opt-out from any third party websites, you must go to that specific website to
unsubscribe and/or opt-out. The Limelight Internet Showcase, LLCwill continue to adhere to
the privacy policy described herein with respect to any personal information previously
collected.</p>
<h3>Links to Other Web Sites</h3>
<p>
Our website does contain links to affiliate and other websites.The Limelight Internet
Showcase, LLCdoes not claim nor accept responsibility for any privacy policies, practices
and/or procedures of other such websites. Therefore, we encourage all users and visitors to
be aware when they leave our website and to read the privacy statements of each and every
website that collects personally identifiable information. The aforementioned Privacy Policy
Agreement applies only and solely to the information collected by our website.</p>
<h3>Security</h3>
<p>
The Limelight Internet Showcase, LLC shall endeavor and shall take every precaution to
maintain adequate physical, procedural and technical security with respect to its offices and
...
<p>
The Limelight Internet Showcase, LLCreserves the right to update and/or change the terms of
our privacy policy, and as such we will post those changes to our website, so that our users
...
The Limelight Internet Showcase, LLC decides to make use of any personally identifiable
information on file, in a manner vastly different from that which was stated when this
information was initially collected, the user or users shall be promptly notified by email. Users
at that time shall have the option as to whether or not to permit the use of their information in
this separate manner.</p>
...
and conditions shall mean that you are in agreement and acceptance of such changes.</p>
...
address.</p>
<p>Email: <ExternalLink href="mailto:info@tllis.net">info@tllis.net</ExternalLink></p>
<p>
Mailing Address:
<br />
The Limelight Internet Showcase, LLC
<br />
1474 Innes Ave
<br />
